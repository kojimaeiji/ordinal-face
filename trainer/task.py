...
from trainer.model import DataSequence, get_meta
import random
    ...
    def on_epoch_begin(self, epoch, logs={}):
        if epoch > 0 and epoch % self.eval_frequency == 0:
            ...
            if len(checkpoints) > 0:
                ...
                data_sequence = DataSequence(self.eval_prefix, self.eval_files, self.debug_mode, self.meta_data, batch_size=32, data_type='cv')
